"""
Innovative Model Training Script
Used to train the innovative hybrid model for time series power prediction.
"""
import os
import sys
import json
...
from models.innovative_model import create_innovative_model
...
class InnovativeTrainer:
    ...
    def build_model(self):
        ...
        # Create model
        self.model = create_innovative_model(
...
def main():
    """Main function."""
    parser = argparse.ArgumentParser(description='Innovative Model Training')
    ...
    print(f"Running Innovative model, Task: {args.task}, Model Size: {args.model_size}")

    config = get_config('innovative', args.task, model_size=args.model_size)
    ...
    if args.results_dir:
        ...
        config['results_dir'] = f"results/innovative_{args.task}{model_size_str}_{timestamp}"
